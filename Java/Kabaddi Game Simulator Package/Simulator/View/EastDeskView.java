 ...
 * @author Nagarjuna
 */
public class EastDeskView extends javax.swing.JPanel {
    ...
    public EastDeskView(Engine engine){
        this.engine = engine;
    ...
    private void DrawDesk(Graphics2D g2D) {
        ...
        g2D.drawRect(width*3/4, (height - KabaddiConstants.DESK_GAP*noOfPlayers)/2 , width/4, (KabaddiConstants.DESK_GAP*noOfPlayers));
    }

    private void DrawPlayers(Graphics2D g2D) {
        g2D.setColor(KabaddiConstants.TEAM_Y_COLOR);

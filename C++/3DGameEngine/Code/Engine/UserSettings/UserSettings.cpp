			...
			if ( lua_isnumber( &io_luaState, -1 ) )
			{
				...
				if ( IsNumberAnInteger( floatingPointResult ) )
				{
					if ( floatingPointResult >= lua_Number( 0 ) )
					{
						...
						eae6320::Logging::OutputMessage("Loading game with resolutionWidth = %u ", s_resolutionWidth);
					}
					else
					{
			...
			if ( lua_isnumber( &io_luaState, -1 ) )
			{
				...
				if ( IsNumberAnInteger( floatingPointResult ) )
				{
					if ( floatingPointResult >= lua_Number( 0 ) )
					{
						...
						eae6320::Logging::OutputMessage("Loading game with resolutionHeight = %u ", s_resolutionHeight);
					}
					else
					{

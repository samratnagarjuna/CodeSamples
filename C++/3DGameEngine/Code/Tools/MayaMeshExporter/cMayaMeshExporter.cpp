...
namespace
{
		...
		const std::vector<sMaterialInfo>& i_materialInfo )
	{
		...
		{
			// Initial comments
			fout << "-- [[ This file has data for a mesh ]]\n\n";
			fout << "-- return mesh data as a table\n";
			...
			// Start of mesh table
			{
				...
				{
					fout << "\t";
					fout << "-- This table contains vertices in the mesh\n";
					fout << "\t";
					fout << "vertices = \n"
						"\t{\n";
					...
					{
						// Comment on vertex index
						fout << "\t\t";
						fout << "-- " << i << "\n";
						{
							// Start of vertex table
							fout << "\t\t";
							fout << "{\n";
							// position
							{
								fout << "\t\t\t";
								fout << "position = { ";
								fout << i_vertexBuffer[i].vertex.x << ", ";
								fout << i_vertexBuffer[i].vertex.y << ", ";
								fout << i_vertexBuffer[i].vertex.z << ", ";
								fout << "},\n";
							}
							// normal
							{
								fout << "\t\t\t";
								fout << "normal = { ";
								fout << i_vertexBuffer[i].vertex.nx << ", ";
								fout << i_vertexBuffer[i].vertex.ny << ", ";
								fout << i_vertexBuffer[i].vertex.nz << ", ";
								fout << "},\n";
							}
							// tangent
							{
								fout << "\t\t\t";
								fout << "tangent = { ";
								fout << i_vertexBuffer[i].vertex.tx << ", ";
								fout << i_vertexBuffer[i].vertex.ty << ", ";
								fout << i_vertexBuffer[i].vertex.tz << ", ";
								fout << "},\n";
							}
							// bitangent
							{
								fout << "\t\t\t";
								fout << "bi_tangent = { ";
								fout << i_vertexBuffer[i].vertex.btx << ", ";
								fout << i_vertexBuffer[i].vertex.bty << ", ";
								fout << i_vertexBuffer[i].vertex.btz << ", ";
								fout << "},\n";
							}
							// texture coordinates
							{
								fout << "\t\t\t";
								fout << "texture_coordinates = { ";
								fout << i_vertexBuffer[i].vertex.u << ", ";
								fout << i_vertexBuffer[i].vertex.v << ", ";
								fout << "},\n";
							}
							// color
							{
								fout << "\t\t\t";
								fout << "color = { ";
								fout << i_vertexBuffer[i].vertex.r << ", ";
								fout << i_vertexBuffer[i].vertex.g << ", ";
								fout << i_vertexBuffer[i].vertex.b << ", ";
								fout << i_vertexBuffer[i].vertex.a << ", ";
								fout << "},\n";
							}
							// end of vertex table
							fout << "\t\t";
				...
				// Outputting Indices
				{
					// Start of indices table
					fout << "\t";
					fout << "-- This table contains indices for triangles in the mesh\n";
					fout << "\t";
					fout << "indices =  \n"
						"\t{\n";

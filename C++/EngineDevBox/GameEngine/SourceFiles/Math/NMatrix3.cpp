...
namespace Illehc
{
	...
	Vector3 Matrix3::MultiplyLeft(const Vector3 & i_Vector) const
	{
		...
		return Vector3(
			i_Vector.getX() * m_11 + i_Vector.getY() * m_21 + i_Vector.getZ() * m_31,
			i_Vector.getX() * m_12 + i_Vector.getY() * m_22 + i_Vector.getZ() * m_32,
			i_Vector.getX() * m_13 + i_Vector.getY() * m_23 + i_Vector.getZ() * m_33);
	}
	...
	Vector3 Matrix3::MultiplyRight(const Vector3 & i_Vector) const
	{
		...
		return Vector3(
			i_Vector.getX() * m_11 + i_Vector.getY() * m_12 + i_Vector.getZ() * m_13,
			i_Vector.getX() * m_21 + i_Vector.getY() * m_22 + i_Vector.getZ() * m_23,
			i_Vector.getX() * m_31 + i_Vector.getY() * m_32 + i_Vector.getZ() * m_33);
	}

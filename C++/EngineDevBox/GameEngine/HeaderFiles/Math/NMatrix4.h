...
#ifndef __ENGINE__NMATRIX4__H__
#define __ENGINE__NMATRIX4__H__
...
namespace Illehc
{
	...
	private:
		...
		inline bool IsEqual(const float i_lhv, const float i_rhv) const;
		inline bool IsZero(const float i_val) const;
		inline bool AreEqual_Eps(const float i_lhv, const float i_rhv, const float i_eps) const;
	};
...
#include "NMatrix4-inl.h"

#endif // !__ENGINE__NMATRIX__H__
